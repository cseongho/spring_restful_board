...
<!-- 
<link rel="stylesheet" href="${app}/resources/js/jquery-ui-themes-1.12.1/themes/base/jquery-ui.css">
	...
	var mytable = "<table border='1'><tr><td>";
  	$.each( data, function( key, val ) {
    	...
    	if (val['userDTO']['usr_id'] == '${sessionScope.userInfo.usr_id}') {
    		mytable += "<span class='ui-icon ui-icon-closethick btnDeleteOk' myval='" + val['com_no'] + "' style='cursor:pointer' /></td>";
    		mytable += "<td><span class='ui-icon ui-icon-pencil     btnUpdateOk' myval='" + val['com_no'] + "' style='cursor:pointer' />";
    	}
    	mytable += "</td></tr>";
...
<tr>
	<th>작성일</th>
	<td><fmt:formatDate value="${dto.art_regdate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
</tr>
<tr>
	<th>조회수</th>
...
<tr>
	<th>추천</th>
	<td><span id="good_count">${dto.art_like}</span><img src="${app}/resources/img/like.png" id="good" /></td>
</tr>
<tr>
	<th>비추천</th>
	<td><span id="bad_count">${dto.art_dislike}</span><img src="${app}/resources/img/dislike.png" id="bad" /></td>
</tr>
<tr>
	<th>작성자ip</th>
	<td>${dto.art_ip}</td>
